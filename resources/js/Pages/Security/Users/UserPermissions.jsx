...
export default function RolePermissions(props){
    const {permissions, flash, auth, existing_permissions, user} = props
    ...
    function submit(values){
        Inertia.post(route('users.update_permission', user.id), values)
    }
    ...
    return (
        <Authenticated
            flash={flash}
            auth={auth}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">User Permissions Management</h2>}
        >
            <Head>
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <Card>
                            <CardHeader back={route('users.index')} can={props.can} />
